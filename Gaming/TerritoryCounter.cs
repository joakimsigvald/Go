...
namespace Go.Gaming
{
    public class TerritoryCounter
    {
        ...
        private GameResult FillIngPoints()
        {
            ...
            EndPlayer blackScorePlayer = new EndPlayer(_smartBoard) { Color = BoardState.Black };
            EndPlayer whiteScorePlayer = new EndPlayer(_smartBoard) { Color = BoardState.White };
